                            ...
                            <ul>
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="assets2/images/!sample-user.jpg" alt="Joseph Doe Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="assets2/images/!sample-user.jpg" alt="Joseph Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="assets2/images/!sample-user.jpg" alt="Joe Junior"
                                                 class="img-circle"/>
                                        </figure>
            ...
            <div id="userbox" class="userbox">
                <a href="#" data-toggle="dropdown">
                    <figure class="profile-picture">
                        <img src="assets2/images/!logged-user.jpg" alt="Joseph Doe" class="img-circle"
                                    ...
                                    <div class="chart-data-selector" id="salesSelectorWrapper">
                                        ...
                                        <div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
                                            ...
                                            <script>
                                                ...
                                                // See: assets2/javascripts/dashboard/examples.dashboard.js for more settings.
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <p class="panel-subtitle">It's easy to create custom graphs on Porto Admin Template, there
                                are several graph types that you can use, such as lines, bars, pie charts, etc...</p>
                        </header>
                        <div class="panel-body">
                                ...
                                <header class="panel-heading bg-primary">
                                    ...
                                    <div class="widget-profile-info">
                                        <div class="profile-picture">
                                            <img src="assets2/images/!logged-user.jpg">
                                        </div>
                                                ...
                                                <ul class="simple-user-list mb-xlg">
                                                    <li>
                                                        <figure class="image rounded">
                                                            <img src="assets2/images/!sample-user.jpg"
                                        ...
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <p>
                                                    ...
                                                    Admin is <span class="text-primary">#awesome</span>
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <div class="thumbnail-gallery">
                                                    <a class="img-thumbnail lightbox"
                                                       href="assets2/images/projects/project-4.jpg"
                                                       data-plugin-options='{ "type":"image" }'>
                                                        <img class="img-responsive" width="215"
                                                             src="assets2/images/projects/project-4.jpg">
                                                        <span class="zoom">
                    ...
                    <div class="sidebar-widget widget-friends">
                        ...
                        <ul>
                            <li class="status-online">
                                <figure class="profile-picture">
                                    <img src="assets2/images/!sample-user.jpg" alt="Joseph Doe" class="img-circle">
                                </figure>
                                <div class="profile-info">
